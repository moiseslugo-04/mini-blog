...
export async function Header({ postQuantity, tagsQuantity }: HeaderProps) {
  return (
    <div className='text-center max-w-4xl mx-auto'>
      ...
      <div className='flex flex-wrap justify-center gap-8 md:gap-12 mb-8'>
        <div className='text-center'>
          <div className='text-3xl font-bold text-primary'>{postQuantity}</div>
        ...
        <div className='text-center'>
          <div className='text-3xl font-bold text-primary'>{tagsQuantity}</div>
          <div className='text-sm text-muted-foreground uppercase tracking-wider'>
            Tags
          </div>
        </div>
